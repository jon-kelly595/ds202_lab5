...
The weekend has the most accidents with Saturday having the most, with most accidents occurring from 4-6 which would correspond with rush hour traffic, and males have more accidents than Females. 
...
Counties around LA seem to be the most dangerous, which makes sense with how dense southern California is. Interestingly though Ney York and the north east seem very safe and the phoenix area seems much more dangerous that I would have expected.
